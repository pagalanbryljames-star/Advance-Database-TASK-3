...
$sql = "SELECT ProductName,  FORMAT(price, 2) AS formatted_price FROM products;";
...
<h2>Output for FORMAT() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["formatted_price"] . "</td>";
        echo "</tr>";
    }
} else {
