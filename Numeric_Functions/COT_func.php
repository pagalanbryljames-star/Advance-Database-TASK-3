...
$sql = "SELECT ProductName, price, COT(6) AS CotValue FROM products WHERE ID = 1;";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["CotValue"] . "</td>";
        echo "</tr>";
    }
} else {
