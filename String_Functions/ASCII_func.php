<?php
include '../db.php';
$sql = "SELECT ProductName, ASCII(ProductName) AS result FROM products";
...
<h2>Output for ASCII() Function</h2>
...
<table class='table table-striped table-hover mt-2 rounded-3 overflow-hidden shadow-sm'>
