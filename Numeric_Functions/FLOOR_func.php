...
$sql = "SELECT ProductName, price ,FLOOR(price) AS floorPriceValue  FROM products LIMIT 5;";
...
<h2>Output for FLOOR Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["floorPriceValue"] . "</td>";
        echo "</tr>";
    }
} else {
