...
$sql = "SELECT fname, lname, STRCMP(fname, lname) AS StringCompare FROM customers;";
...
<h2>Output for STRCMP() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["StringCompare"] . "</td>";
        echo "</tr>";
    }
} else {
