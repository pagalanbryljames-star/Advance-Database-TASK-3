<?php
include '../db.php';
$sql = "SELECT fname, lname, email, CONCAT_WS('-', fname, lname, email) AS ConcatenatedStringWithSeparator FROM customers;";
...
<h2>Output for CONCAT_WS() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["ConcatenatedStringWithSeparator"] . "</td>";
        echo "</tr>";
    }
} else {
