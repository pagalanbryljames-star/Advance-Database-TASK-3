...
$sql = "SELECT fname, lname, CONCAT(fname,' ', lname) AS ConcatenatedString FROM customers;";
...
<h2>Output for CONCAT() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["ConcatenatedString"] . "</td>";
        echo "</tr>";
    }
} else {
