...
$sql = "SELECT ProductName, price, LEAST(price, 1230, 2400, 3028)AS LEASTValue FROM products LIMIT 5;";
...
<h2>Output for LEAST() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["LEASTValue"] . "</td>";
        echo "</tr>";
    }
} else {
