...
$sql = "SELECT lname,  MID(lname,5,3) AS ExtractString FROM customers ";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td class='text-start'>" . htmlspecialchars($row["lname"]) . "</td>";
        echo "<td class='text-center'>" . $row["ExtractString"] . "</td>";
        echo "</tr>";
    }
} else {
