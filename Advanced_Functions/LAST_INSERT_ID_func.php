...
$insert = "INSERT INTO customers (fname, lname, email) VALUES ('Jose', 'Rizzal', 'jrizzal@gmail.com');";
$conn->query($insert);
...
<body>
    <div class='container mt-5'>
        <div class=d-flex justify-content-between align-items-center mb-4>
            <h2>Output for LAST_INSERT_ID() Function</h2>
