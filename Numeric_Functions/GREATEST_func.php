...
$sql = "SELECT ProductName, price, GREATEST(price, 100) AS GreatestValue FROM products LIMIT 5;";
...
<h2>Output for GREATEST() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["GreatestValue"] . "</td>";
        echo "</tr>";
    }
} else {
