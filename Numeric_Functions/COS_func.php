...
$sql = "SELECT ProductName, price, COS(2) AS CosValue FROM products WHERE ID = 1;";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["CosValue"] . "</td>";
        echo "</tr>";
    }
} else {
