...
$sql = "SELECT fname,  INSERT(fname, 1,3,'demo') AS InsertedString FROM customers;";
...
<h2>Output for INSERT() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["InsertedString"] . "</td>";
        echo "</tr>";
    }
} else {
