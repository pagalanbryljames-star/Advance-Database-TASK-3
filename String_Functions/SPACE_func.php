...
$sql = "SELECT fname, lname, CONCAT(fname, SPACE(5), lname) AS SpacedString FROM customers;";
...
<h2>Output for SPACE() Function</h2>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["SpacedString"] . "</td>";
        echo "</tr>";
    }
} else {
