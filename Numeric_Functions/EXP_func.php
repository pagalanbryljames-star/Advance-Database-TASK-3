...
$sql = "SELECT ProductName, FORMAT(price,2) AS price, EXP(2) AS EXPValue FROM products WHERE ID = 1;";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["EXPValue"] . "</td>";
        echo "</tr>";
    }
} else {
