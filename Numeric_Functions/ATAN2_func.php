...
$sql = "SELECT ProductName, price, ATAN2(0.50, 1) AS Atan2Value FROM products LIMIT 5;";
...
<h2>Output for ATAN2() Function</h2>
...
<table class='table table-striped table-hover rounded-3 overflow-hidden shadow-sm'>
    <thead style='background-color:#04AA6D; color:white'>
        <tr>
            ...
            <th class=text-center>ATAN2(0.50, 1)</th>
        </tr>
    </thead>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>" . $row["Atan2Value"] . "</td>";
        echo "</tr>";
    }
} else {
